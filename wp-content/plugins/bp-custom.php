...
function display_user_lastname($activity_action) {
    global $bp;
	$user_id = bp_get_activity_user_id();
    $args = array(
        'field'   => 'Last Name', // Field name or ID.
        );
    $last_name = xprofile_get_field_data( $args, $user_id);

    return $last_name." ".$activity_action;
