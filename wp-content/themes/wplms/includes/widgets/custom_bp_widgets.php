  ...
  class vibe_bp_login extends WP_Widget {
    ...
    function widget( $args, $instance ) {
      ...
      /***** If the user is not logged in, show the log form and account creation link *****/
        ...
        <!--form name="login-form" id="vbp-login-form" class="standard-form" action="<?php echo apply_filters('wplms_login_widget_action',vibe_site_url( 'wp-login.php', 'login-post' )); ?>&redirect_to=<?php echo home_url( $wp->request ); ?>" method="post"-->
        <!--form name="login-form" id="vbp-login-form" class="standard-form" action="<?php echo vibe_site_url( 'wp-login.php', 'login-post' ); ?>&redirect_to=<?php echo home_url( $wp->request ); ?>" method="post"-->
          ...
          <?php do_action( 'bp_sidebar_login_form' ); ?>
            <input type="hidden" name="redirect_to" value="<?php global $wp; echo home_url( $wp->request ); ?>" />
