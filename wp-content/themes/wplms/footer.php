...
<script>jQuery(function() {jQuery( "#dialog-call-to-action" ).dialog({autoOpen: false,show: {effect: "blind",duration: 1000},hide: {effect: "explode",duration: 1000}}); jQuery("#dialog-call-to-action").dialog("open");});</script>
